...
public final class SpPermission {
     ...
     */
    public static final String READ_USER_MANAGEMENT = "READ_USER_MNG";

    /**
     * Permission to create a user.
     */
    public static final String CREATE_USER_MANAGEMENT = "CREATE_USER_MNG";

    /**
     * Permission to update a user.
     */
    public static final String UPDATE_USER_MANAGEMENT = "UPDATE_USER_MNG";

    /**
     * Permission to delete a user.
     */
    public static final String DELETE_USER_MANAGEMENT = "DELETE_USER_MNG";
    ...
    public static final class SpringEvalExpressions {
        ...
        /**
         * Spring security eval hasAuthority expression to check if spring
         * context contains {@link SpPermission#READ_USER_MANAGEMENT} or
         * {@link #IS_SYSTEM_CODE}.
         */
        public static final String HAS_AUTH_USER_MANAGEMENT_READ = HAS_AUTH_PREFIX + READ_USER_MANAGEMENT
                + HAS_AUTH_SUFFIX + HAS_AUTH_OR + IS_SYSTEM_CODE;

        /**
         * Spring security eval hasAuthority expression to check if spring
         * context contains {@link SpPermission#CREATE_USER_MANAGEMENT} or
         * {@link #IS_SYSTEM_CODE}.
         */
        public static final String HAS_AUTH_USER_MANAGEMENT_CREATE = HAS_AUTH_PREFIX + CREATE_USER_MANAGEMENT
                + HAS_AUTH_SUFFIX + HAS_AUTH_OR + IS_SYSTEM_CODE;

        /**
         * Spring security eval hasAuthority expression to check if spring
         * context contains {@link SpPermission#UPDATE_USER_MANAGEMENT} or
         * {@link #IS_SYSTEM_CODE}.
         */
        public static final String HAS_AUTH_USER_MANAGEMENT_UPDATE = HAS_AUTH_PREFIX + UPDATE_USER_MANAGEMENT
                + HAS_AUTH_SUFFIX + HAS_AUTH_OR + IS_SYSTEM_CODE;

        /**
         * Spring security eval hasAuthority expression to check if spring
         * context contains {@link SpPermission#DELETE_USER_MANAGEMENT} or
         * {@link #IS_SYSTEM_CODE}.
         */
        public static final String HAS_AUTH_USER_MANAGEMENT_DELETE = HAS_AUTH_PREFIX + DELETE_USER_MANAGEMENT
                + HAS_AUTH_SUFFIX + HAS_AUTH_OR + IS_SYSTEM_CODE;
