...
public final class MgmtRestConstants {
    ...
    /**
     * The privileges URL mapping rest resource.
     */
    public static final String PRIVILEGE_V1_REQUEST_MAPPING = BASE_V1_REQUEST_MAPPING + "/privileges";

    /**
     * The User Roles URL mapping rest resource.
     */
    public static final String USER_ROLE_V1_REQUEST_MAPPING = BASE_V1_REQUEST_MAPPING + "/userroles";

    /**
     * The Users URL mapping rest resource.
     */
    public static final String USER_V1_REQUEST_MAPPING = BASE_V1_REQUEST_MAPPING + "/users";

    /**
     * The password reset URL mapping rest resource.
     */
    public static final String PASSWORD_V1_REQUEST_MAPPING = BASE_V1_REQUEST_MAPPING + "/password";
